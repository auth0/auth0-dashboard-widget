...
module.exports = function(data,options) {
  ...
  var WIDTH=Math.round(bounding_box.width);
  var HEIGHT=Math.round(bounding_box.height);
  ...
  d3.select(options.container).classed('parallel-coordinates', true);
  ...
  function updateMarkers(duration) {
    ...
    var new_markers=marker.enter()
            .append("g")
              ...
              .attr("transform",function(d){
                ...
                var y=yscales[d.column].range()[0];
    ...
    marker
      ...
      .attr("transform",function(d){
        ...
        var x=xscale(d.column);
        var y=yscales[d.column](d.value/d.ref);
  ...
  function updateLabels(duration) {
    ...
    labels
      .attr("transform",function(d){
        ...
        var x=xscale(d.column);
        var y=yscales[d.column](d.value);
